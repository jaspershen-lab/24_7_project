...
setwd("3_data_analysisk_means_analysis/all_omics_loess_data")
...
load(here::here("3_data_analysisinter_omics_correlation/inter_all_omics/global correlation network/global_cor"))
global_cor
