...
{
  ###
  load(here::here("3_data_analysiscombine_omics/data_preparation/expression_data"))
  load(here::here("3_data_analysiscombine_omics/data_preparation/sample_info"))
  load(here::here("3_data_analysiscombine_omics/data_preparation/variable_info"))
}

setwd("3_data_analysisk_means_analysis/all_omics")
