...

{
  ...
  ###internal omics data
  ###cortisol
  load("3_data_analysiscortisol/data_preparation/sample_info")
  load("3_data_analysiscortisol/data_preparation/variable_info")
  load("3_data_analysiscortisol/data_preparation/expression_data")
  cortisol_expression_data = expression_data
  cortisol_sample_info = sample_info
  cortisol_variable_info = variable_info
  
  ###cytokine
  load("3_data_analysiscytokine/data_preparation/sample_info")
  load("3_data_analysiscytokine/data_preparation/variable_info")
  load("3_data_analysiscytokine/data_preparation/expression_data")
  cytokine_sample_info = sample_info
  cytokine_variable_info = variable_info
  cytokine_expression_data = expression_data
  
  ###lipidomics
  load("3_data_analysislipidomics/data_preparation/sample_info")
  load("3_data_analysislipidomics/data_preparation/variable_info")
  load("3_data_analysislipidomics/data_preparation/expression_data")
  lipidomics_sample_info = sample_info
  lipidomics_variable_info = variable_info
  lipidomics_expression_data = expression_data
  
  ###metabolic_panel
  load("3_data_analysismetabolic_panel/data_preparation/sample_info")
  load("3_data_analysismetabolic_panel/data_preparation/variable_info")
  load("3_data_analysismetabolic_panel/data_preparation/expression_data")
  ...
  # ###metabolomics
  # load("3_data_analysismetabolomics/data_preparation/metabolites/sample_info")
  # load("3_data_analysismetabolomics/data_preparation/metabolites/variable_info")
  # load("3_data_analysismetabolomics/data_preparation/metabolites/expression_data")
  # metabolomics_sample_info = sample_info
  # metabolomics_variable_info = variable_info
  # metabolomics_expression_data = expression_data
  # 
  # load("3_data_analysismetabolomics/data_preparation/peaks/sample_info")
  # load("3_data_analysismetabolomics/data_preparation/peaks/variable_info")
  # load("3_data_analysismetabolomics/data_preparation/peaks/expression_data")
  ...
  ###proteomics
  load("3_data_analysisproteomics/data_preparation/sample_info")
  load("3_data_analysisproteomics/data_preparation/variable_info")
  load("3_data_analysisproteomics/data_preparation/expression_data")
  proteomics_sample_info = sample_info
  proteomics_variable_info = variable_info
  proteomics_expression_data = expression_data
  
  ###total protein
  load("3_data_analysistotal_protein/data_preparation/sample_info")
  load("3_data_analysistotal_protein/data_preparation/variable_info")
  load("3_data_analysistotal_protein/data_preparation/expression_data")
...
setwd("3_data_analysissummary_info")
