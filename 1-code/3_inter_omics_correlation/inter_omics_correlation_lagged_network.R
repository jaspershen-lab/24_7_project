...
lipidomics_variable_info = 
  readxl::read_xlsx("3_data_analysislipidomics/k_means_clustering/final_info_manual.xlsx")

load("3_data_analysislipidomics/k_means_clustering/new_variable_info")
load("3_data_analysislipidomics/k_means_clustering/new_expression_data")

lipidomics_variable_info = 
  new_variable_info

####load all omics data loess data
load(here::here("3_data_analysiscombine_omics/data_preparation/new_expression_data"))
load(here::here("3_data_analysiscombine_omics/data_preparation/new_sample_info"))
load(here::here("3_data_analysiscombine_omics/data_preparation/new_variable_info"))
...
load("3_data_analysissummary_info/day_night_df")
...
######
setwd("3_data_analysisinter_omics_correlation/inter_all_omics_loess_data")
