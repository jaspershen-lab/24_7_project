...
load(
  here::here(
    "3_data_analysiscombine_omics/data_preparation/new_expression_data"
  )
)
load(here::here(
  "3_data_analysiscombine_omics/data_preparation/new_sample_info"
))
load(here::here(
  "3_data_analysiscombine_omics/data_preparation/new_variable_info"
))
